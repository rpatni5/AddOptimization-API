...
namespace AddOptimization.Services.Services
{
    public class InvoicePaymentHistoryService : IInvoicePaymentHistoryService
    {
        ...
        public InvoicePaymentHistoryService(IGenericRepository<InvoicePaymentHistory> invoicePaymentRepository, ILogger<InvoicePaymentHistoryService> logger, IMapper mapper, IInvoiceStatusService invoiceStatusService, IInvoiceService invoiceService, IPaymentStatusService paymentStatusService, IGenericRepository<InvoiceHistory> invoiceHistoryRepository, IGenericRepository<Invoice> invoiceRepository, IGenericRepository<InvoiceCreditNotes> invoiceCreditNoteRepository)
        {
