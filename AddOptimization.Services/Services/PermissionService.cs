...
public class PermissionService: IPermissionService
{
    ...
    //public PermissionService(ILogger<PermissionService> logger, IHttpContextAccessor httpContextAccessor, IMemoryCache cache, IGenericRepository<RolePermission> rolePermissionRepository, IGenericRepository<Screen> screenRepository, IGenericRepository<Notification> notificationRepository, IGenericRepository<ApplicationUser> applicationUserRepository, IGenericRepository<Role> roleRepository, IGenericRepository<Field> fieldRepository)
    //{
